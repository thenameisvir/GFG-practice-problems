...
<pre><span style="font-size: 18px;"><strong>Input: </strong>n1 = 5 , n2 = 6  root = [1,2,3,4,5,6,7]
...
<pre><span style="font-size: 18px;"><strong style="font-size: 18px;">Input: </strong><span style="font-size: 18px;">n1 = 3 , n2 = 4 root = [5, 2, N, 3, 4]<br>
           5    
      &nbsp;   /    
      &nbsp;  2  
      &nbsp; / \  
...
<pre><span style="font-size: 14pt;"><strong style="font-size: 14pt;">Input: </strong><span style="font-size: 14pt;">n1 = 5 , n2 = 4 root = </span><span style="font-size: 18.6667px;">[5, 2, N, 3, 4]<br></span><span style="font-size: 14pt;">
           5    
      &nbsp;   /    
      &nbsp;  2  
      &nbsp; / \  
